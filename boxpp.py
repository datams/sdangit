...
def plot(lpt, avg_lpr, gnt, avg_gnr, gntf, grt, avg_grr, filename):
	...
	ax.set_xticklabels(['LP: '+str(round(avg_lpr,3)), 'GA: '+str(round(avg_gnr,3)), '(GA gene pool)', 'Greedy: '+str(round(avg_grr,3))], fontsize=18)
	...
	# Save the figure
	fig.savefig(filename+'_lin', bbox_inches='tight')
